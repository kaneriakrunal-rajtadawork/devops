...
export async function POST(request, { params }) {
  try {
    ...
    const result = await workItemService.addPullRequest(params.id, body, userId);
    
    return ApiResponse.success(result, 'Pull request added to work item successfully');
    
  } catch (error) {
    console.error('Error adding pull request to work item:', error);
