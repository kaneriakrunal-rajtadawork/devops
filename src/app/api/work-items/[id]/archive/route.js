...
export async function PUT(request, { params }) {
  try {
    ...
    const result = await workItemService.toggleWorkItemArchive(params.id, userId);
    
    return ApiResponse.success(result, 'Work item archive status updated successfully');
    
  } catch (error) {
    console.error('Error updating work item archive status:', error);
